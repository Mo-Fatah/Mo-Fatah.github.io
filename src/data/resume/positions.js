const positions = [
  {
    ...
    points: [
      ...
      'I ran my testcases mainly against Wasmer and Wasmtime and I caught multiple unconsistent behaviors and I opened multiple issues which led to either fix their WASI implementation or imporve the WASI standard.',
    ],
    technologies: [
      'Rust, ',
      'Docker, ',
